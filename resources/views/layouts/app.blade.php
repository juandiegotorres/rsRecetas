...
<body>
    <div id="app">
            ...
            <div class="container">
                <div class="d-flex pb-1">
                    ...
                    {{-- {{ config('app.name', 'Laravel') }} --}}
                        <img src="{{ asset('images/logo_transparent_white.png') }}" class="logo">
                    </a>
        ...
        {{-- <nav class="navbar navbar-expand-md navbar-light categorias-bg">
            <div class="container">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#categorias" aria-controls="categorias" aria-expanded="false">
                ...
                <div class="collapse navbar-collapse" id="categorias">
                    <ul class="navbar-nav w-100 d-flex justify-content-between">
                        ...
                        <li class="nav-item">
                            <a href="" class="nav-link">{{$categoria->nombre}}</a>
                        </li>                            
                        @endforeach
                    </ul>
                </div>
